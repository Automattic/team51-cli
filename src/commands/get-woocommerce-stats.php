	...
	protected function configure() {
		$this
			...
			->setHelp(
				...
				Example usage:\n
				get-woocommerce-stats --unit=year --date=2022\n
				get-woocommerce-stats --unit=week --date=2022-W12\n
				get-woocommerce-stats --unit=month --date=2021-10\n
				get-woocommerce-stats --unit=day --date=2022-02-27"
			)
			->addOption(
				'unit',
				null,
